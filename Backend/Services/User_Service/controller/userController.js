  ...
  try {
    if (req.user) {
      ...
      if (user) {
        ...
        if (req.body.passwords && req.body.passwords?.currentPassword !== '' && req.body.passwords?.newPassword !== '') {
...
module.exports = { getUserData, updateUser, signup, login, resendOtp, verifyOtp, resetPassword };